...
namespace TravelShare.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        private async Task LoadAsync(TravelShareUser user)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                {
                    StatusMessage = "This email is already in use. Please try a different email.";
